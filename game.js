...
//need to convert category column (1-5) to using the categoryId
//chooseCategory
//updateCategory
//randomCategory
//just gonna randomize category on window load and come back to it later
